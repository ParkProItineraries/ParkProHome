...
export const PRICING_PLANS = {
  ...
  solo_plus: {
    ...
    features: [
      ...
      "ParkPro Lead Capture Page – shareable quote request form hosted by ParkPro",
  ...
  enterprise: {
    ...
    features: [
      ...
      "Advanced Lead Integrations – website form integration, API/webhooks, and ParkPro-hosted lead pages",
